        ...
        {sites.length === 0 ? (
          ...
          <div className="space-y-2">
            {sites.map((site) => {
              ...
              const issueTotal = latestScan
                ? latestScan.criticalCount +
                  latestScan.seriousCount +
                  latestScan.moderateCount +
                  latestScan.minorCount
                : 0;
              ...
              return (
                ...
                >
                  ...
                  <p className="text-xs text-slate-500">状态：{site.status}</p>
                  <p className="text-xs text-slate-500">
                    最近扫描：
                    {latestScan ? latestScan.createdAt.toISOString() : "暂无"}
                  </p>
                  <p className="text-xs text-slate-500">
                    问题总数：{issueTotal}
                  </p>
